...
const ImageDetailModal: React.FC<ImageDetailModalProps> = ({
  ...
  const styles = {
    ...
    modalContainer: "fixed inset-0 flex items-center justify-center",
    modalContent: "w-full max-w-4xl mx-4 h-[calc(100vh-2rem)] flex flex-col bg-card border border-border rounded-xl shadow-elevation",
    header: "flex items-center justify-between p-3 sm:p-4 border-b border-border bg-card",
    body: "flex flex-col md:flex-row flex-1 overflow-hidden",
    imageSection: "md:w-2/3 p-3 sm:p-4 bg-secondary/30 flex items-center justify-center overflow-auto",
    detailsSection: "md:w-1/3 p-4 border-t md:border-t-0 md:border-l border-border overflow-y-auto",
    footer: "p-3 sm:p-4 border-t border-border flex justify-end gap-2 bg-card",
    closeButton: "p-1 rounded-full hover:bg-secondary transition-colors",
    image: "max-h-full w-auto object-contain",
